...
@section('header')
    <section class="content-header">
      <h1>
        Subjects<small>All subjects in the database.</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <table id="crudTable" class="table table-striped table-hover display responsive" cellspacing="0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{ route('subject.edit', $row->id) }}" class="btn btn-default btn-xs"><i class="fa fa-edit"></i> Edit</a> 
                  @if(!in_array($row->id, $cantDelete))
                  <button type="submit" class="btn btn-xs btn-default" form="deleteSubject{{$row->id}}"><i class="fa fa-trash"></i> Delete</button>
