      ...
      <div class="box">
        ...
        <div class="form-group col-xs-12">
          ...
          <select class="form-control js-single" name="schoolyear_id">
            ...
            @foreach($schoolyears as $row)
              <option @if($section->schoolyear_id == $row->id) selected @endif value="{{ $row->id }}">{{ $row->year }}</option>
            @endforeach
          </select>
        </div>
        ...
        <div class="form-group col-xs-12">
          ...
          <select class="form-control js-single" name="track_id">
            ...
            @foreach($tracks as $row)
              <option @if($section->track_id == $row->id) selected @endif value="{{ $row->id }}">{{ $row->name }}</option>
            @endforeach
          </select>
        </div>
        ...
        <div class="form-group col-xs-12">
          ...
          <select class="form-control js-single" name="year_level">
            ...
            <option @if($section->year_level == 11) selected @endif value="11">11</option>
            <option @if($section->year_level == 12) selected @endif value="12">12</option>
          </select>
        </div>
        ...
        <div class="form-group col-xs-12">
          ...
          <select class="form-control js-single" name="semester">
            ...
            <option @if($section->semester == 1) selected @endif value="1">1st</option>
            <option @if($section->semester == 2) selected @endif value="2">2nd</option>
          </select>
        </div>
        ...
        <div class="form-group col-xs-12">
          ...
          <select class="form-control js-single" name="adviser">
            ...
            @foreach($teachers as $row)
              <option @if($row->id == $section->adviser) selected @endif value="{{ $row->id }}">{{ $row->firstname. ' ' .$row->middlename. ' ' .$row->lastname . ' (Employee id: ' .$row->employee_id. ')'}}</option>
            @endforeach
          </select>
        </div>
