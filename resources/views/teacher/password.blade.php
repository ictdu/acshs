                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li><a href="{{ route('teacher.information') }}"><i class="menu-icon icon-user"></i> Profile</a></li>
                                <li><a class="active" href="{{ route('teacher.password') }}"><i style="color: white;" class="menu-icon icon-lock"></i> Change Password</a></li>
                            </ul>
                            <!--/.widget-nav-->
                        </div>
                        <!--/.sidebar-->
                    ...
                    <div class="content">
                        <div class="module">
                            ...
                            <form class="form-horizontal" action="{{ route('teacher.password.submit') }}" method="POST">
                              {{ csrf_field() }}
