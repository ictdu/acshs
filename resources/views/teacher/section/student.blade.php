                          ...
                          <div class="module-body">
                            <div class="profile-head media">
                              ...
                              <div class="media-body">
                                ...
                                <h4>{{ $student->firstname. ' ' .$student->middlename. ' ' .$student->lastname}} <small>{{ $student->lrn }}</small></h4>
                              </div>
                            </div>
                          </div>   
                        </div>
                            ...
                            <div class="module">
                              <div class="module-body">
                                <div class="profile-head media">
                                  ...
                                  <a style="margin-top: 10px;" href="{{ route('teacher.section.student.grades.pdf', [$selectedSection['id'], $student->id]) }}" class="btn btn-success"> View as PDF</a>
                              </div>
                            </div>
                            <div class="module">
