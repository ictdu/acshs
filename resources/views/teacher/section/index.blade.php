                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav nav-icons">
                            <li class="active"><a style="color:white;" href="#"><i class="icon-list"></i> Classes</a></li>
                        </ul>
                                        ...
                                        <tbody>
                                          @foreach($sections as $row)
                                            <tr>
                                              ...
                                              <td>{{ $row->students }}</td>
                                              <td><a href="{{ route('teacher.section.subjects', $row->id) }}" class="btn btn-warning btn-xs">Manage Section</a></td>
                                            </tr>
                                          @endforeach
                                        </tbody>
                                        <tfoot>
