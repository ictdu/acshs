...
<head>
    ...
    <title>
      {{ isset($title) ? $title.' :: Student' : ' Student' }}
    </title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('') }}" class="logo">
          ...
          <span class="logo-mini">@if($logoEmpty) SP @else <img width="40" height="40" src="{{ asset('img/logo/'.$publicLogo->image) }}"> @endif</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">@if($schoolnameEmpty) SPCFPartners @else {{ $publicSchoolname->abbreviation }} @endif</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          @include('students-inc.menu')
        </nav>
      </header>

      <!-- =============================================== -->

      @include('students-inc.sidebar')
      ...
      <footer class="main-footer">
        ...
        Powered by <a href="https://www.spcf.edu.ph/">SPCF</a>
      </footer>
    </div>
    <!-- ./wrapper -->
