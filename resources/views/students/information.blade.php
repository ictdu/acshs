                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav nav-icons">
                            <li><a style="color:white;" href="{{ route('student.classes') }}"><i class="icon-list"></i> Classes</a></li>
                        </ul>
                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li><a class="active" href="{{ route('student.information') }}"><i style="color: white;" class="menu-icon icon-user"></i> Profile</a></li>
                                <li><a href="{{ route('student.password') }}"><i class="menu-icon icon-lock"></i> Change Password</a></li>
                            </ul>
                            <!--/.widget-nav-->
                        </div>
                        <!--/.sidebar-->
                    ...
                    <div class="content">
                        <div class="module">
                            <div class="module-body">
                                <div class="profile-head media" style="padding-bottom: 15px;">
                                    ...
                                    <div class="media-body">
                                        <h4>
                                            {{ Auth::guard('student')->user()->firstname. ' ' .Auth::guard('student')->user()->middlename. ' ' .Auth::guard('student')->user()->lastname }}<small>{{ Auth::guard('student')->user()->lrn }}</small>
                                        </h4>
                                        <p class="profile-brief">
                                            {{ Auth::guard('student')->user()->gender }}
                                        </p>
                                        <p class="profile-brief">
                                            {{ date("M d, Y", strtotime(Auth::guard('student')->user()->birthday)) }}
                                        </p>
                                    </div>
                                  </div>
                            </div>
                            ...
                            <form class="form-horizontal" action="{{ route('student.information.submit') }}" method="POST">
                              {{ csrf_field() }}
                              <div class="control-group" style="padding-top: 20px;">
                                <label class="control-label" for="basicinput">Contact</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input type="text" name="contact" id="basicinput" value="{{ Auth::guard('student')->user()->contact }}" class="span3">
                                </div>

                                <label class="control-label" for="basicinput">Address1</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input type="text" name="address1" id="basicinput" value="{{ Auth::guard('student')->user()->address1 }}" class="span3">
                                </div>

                                <label class="control-label" for="basicinput">Address2</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input type="text" name="address2" id="basicinput" value="{{ Auth::guard('student')->user()->address2 }}" class="span3">
                                </div>

                                <label class="control-label" for="basicinput">Barangay</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input type="text" name="barangay" id="basicinput" value="{{ Auth::guard('student')->user()->barangay }}" class="span3">
                                </div>

                                <label class="control-label" for="basicinput">Municipality</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input type="text" name="municipality" id="basicinput" value="{{ Auth::guard('student')->user()->municipality }}" class="span3">
                                </div>

                                <label class="control-label" for="basicinput">Province</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input type="text" name="municipality" id="basicinput" value="{{ Auth::guard('student')->user()->province }}" class="span3">
                                </div>

                                <label class="control-label" for="basicinput">Guardian</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input type="text" name="guardian" id="basicinput" value="{{ Auth::guard('student')->user()->guardian }}" class="span3">
                                </div>
