                ...
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li><a href="{{ route('student.information') }}"><i class="menu-icon icon-user"></i> Profile</a></li>
                                <li><a class="active" href="{{ route('student.password') }}"><i style="color: white;" class="menu-icon icon-lock"></i> Change Password</a></li>
                            </ul>
                            <!--/.widget-nav-->
                        </div>
                        <!--/.sidebar-->
                    ...
                    <div class="content">
                        <div class="module">
                            ...
                            <form class="form-horizontal" action="{{ route('student.password.submit') }}" method="POST">
                              {{ csrf_field() }}
                              <div class="control-group" style="padding-top: 20px;">
                                <label class="control-label" for="basicinput">Old Password</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input minlength="6" type="password" name="oldpassword" id="basicinput" class="span3" required>
                                </div>

                                <label class="control-label" for="basicinput">New Password</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input minlength="6" type="password" name="newpassword" id="basicinput" class="span3" required>
                                </div>

                                <label class="control-label" for="basicinput">Retype New Password</label>
                                <div class="controls" style="margin-bottom: 20px;">
                                  <input minlength="6" type="password" name="newpasswordconfirmation" id="basicinput" class="span3" required>
                                </div>
